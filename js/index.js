...
function preload ()
{
    game.load.image('summer_tiles','/assets/spritesheets/tiles/summer.png');
    game.load.image('winter_tiles','/assets/spritesheets/tiles/winter.png');
    game.load.image('wasteland_tiles','/assets/spritesheets/tiles/wasteland.png');
}
...
function create ()
{
    ...
    tilemap.add('summer_tiles');

    layer1 = map.create('summer_layer', 40, 30, 32, 32);
...
function createTileSelector() {
    ...
    var tileStrip = tileSelector.create(1, 1, 'summer_tiles');
